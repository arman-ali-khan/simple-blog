...
// console.log(post,'post?.post')
  return (
    <div
      className={`flex rounded-md flex-row p-1 overflow-hidden max-h-44 border-b my-1 md:h-fit bg-base-100 sm:h-24  shadow-xl`}
    >
     <Image
      ...
      <div className="rounded-b lg:rounded-b-none lg:rounded-r md:px-2 flex flex-col justify-between w-full">
        <div className="font-bold sm:text-base text-sm leading-tight">
          <Link
            className="hover:text-blue-400 visited:text-purple-500 duration-300 text-blue-500"
